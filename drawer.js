...
root.attr('width', windowWidth*0.6).attr('height', windowHeight);
root.attr('transform', 'translate('+(windowWidth*0.2)+',0)');
...
var Vis = new function () {
    ...
    var parentG = root.append('g')
        .attr('transform', 'translate('+((windowWidth*0.6-(windowWidth*0.2+windowWidth*0.25))/2+windowWidth*0.2)+','+(windowHeight/2)+')');
    ...
    this.drawDimension = function (keys,name) {
        ...
        var g = root.append('g');
        g.attr('transform', 'translate('+((windowWidth*0.6-(windowWidth*0.2+windowWidth*0.25))/2+windowWidth*0.2)+','+(windowHeight/2)+')').attr('id',name);
        ...
        function mouse(e) {
            return [e.pageX-((windowWidth*0.6-(windowWidth*0.2+windowWidth*0.25))/2+windowWidth*0.2), e.pageY-windowHeight/2];
        }
        ...
        function mouseup() {
            if (m0) {
                ...
                g.attr('transform', 'translate('+((windowWidth*0.6-(windowWidth*0.2+windowWidth*0.25))/2+windowWidth*0.2)+','+(windowHeight/2)+')rotate(' + rotate + ')');
                console.log("dm:"+dm);
        ...
        function setState(dm){
            g.attr('transform', 'translate('+((windowWidth*0.6-(windowWidth*0.2+windowWidth*0.25))/2+windowWidth*0.2)+','+(windowHeight/2)+')rotate(' + (rotate + dm) + ')');
        }
